...
def generate_clean_reference_crisislex():
    """
    Generate a collection of reference tweets using the CrisisLexT26 annotation after removing irrelevant categories
...
def generate_clean_reference_pheme():
    """
    Generate a collection of reference tweets using the pheme annotation after removing irrelevant categories
    :return: dataframe containing original reference tweet and pre-processed ref. tweet
    """
