...
nohup ./anaconda3/envs/py3/bin/python3.6 -u /oak01/data/sooji/data_annotation/src/semeval_test.py test > /oak01/data/sooji/data_annotation/train_augmentation/semeval_test.log 2>&1 &
