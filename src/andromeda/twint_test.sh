...
nohup ./anaconda3/envs/py3/bin/python3.6 -u /oak01/data/sooji/data_annotation/src/twint_test.py > /oak01/data/sooji/data_annotation/src/twint_test-re.log 2>&1 &
