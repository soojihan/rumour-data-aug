...
nohup ./anaconda3/envs/py3/bin/python3.6 -u /oak01/data/sooji/data_annotation/src/semeval_test.py dev > /oak01/data/sooji/data_annotation/train_augmentation/semeval_dev.log 2>&1 &
